...
for file_path in tqdm(file_paths, desc="processing files"):
    ...
    plt.plot(time[indices_test], y_test, label='measured capacity', color='blue', linewidth=1)

    # plot the predicted capacity versus time
    plt.plot(time[indices_test], y_pred, label='predicted capacity', color='red', linestyle='--', linewidth=1)
